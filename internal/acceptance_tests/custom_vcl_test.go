...
func TestAccFastlyServiceCustomVCL_basicAndUpdate(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "name", vclName),
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "main", "true"),
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "version", "1"),
					resource.TestCheckResourceAttrSet("fastly_service_custom_vcl.main", "service_id"),
					resource.TestCheckResourceAttrSet("fastly_service_custom_vcl.main", "id"),
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "content", contentOne),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "name", vclName),
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "main", "true"),
					resource.TestCheckResourceAttr("fastly_service_custom_vcl.main", "content", contentTwo),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.#", "1"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.name", vclName),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.main", "true"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.content", contentOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.name", vclName),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.main", "true"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.content", contentTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.#", "2"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.name", mainName),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.main", "true"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.content", mainContent),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.1.name", includeName),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.1.main", "false"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.1.content", includeContent),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "active_version", "1"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.name", vclName),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.main", "true"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.content", content),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "active_version", "1"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "managed_version", "1"),
				),
			},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "custom_vcl.0.content", validContent),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "active_version", "1"),
					resource.TestCheckResourceAttr("fastly_service_cdn_auto.test", "managed_version", "1"),
				),
			},
