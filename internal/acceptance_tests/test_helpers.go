...
func ConfigLoggingCloudfilesBasic(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_basic.tf",
	)
}

func ConfigLoggingCloudfilesUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_updated.tf",
	)
}
...
func ConfigLoggingCloudfilesForImport(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":            serviceName,
...
// ConfigLoggingCloudfilesComputeFormat returns a config attaching
// fastly_service_logging_cloudfiles to an explicit Compute service with format
// set, a VCL-only attribute. The standalone resource's schema is shared by both
// service types, so this is expected to fail at apply time via
// ValidateNoVCLOnlyAttributesForCompute rather than at Terraform's own
// schema-validation stage.
func ConfigLoggingCloudfilesComputeFormat(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/logging_cloudfiles_compute_format.tf",
	)
}

// ConfigLoggingCloudfilesCompute returns a config attaching
// fastly_service_logging_cloudfiles to an explicit Compute service with no
// VCL-only attributes set. ClearVCLOnlyCreateFields strips format from the
// create request, so the endpoint ends up with whatever format the Fastly API
// defaults to - see TestAccFastlyServiceLoggingCloudfiles_formatDefault.
func ConfigLoggingCloudfilesCompute(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/logging_cloudfiles_compute.tf",
	)
}

func ConfigCDNAutoWithLoggingCloudfiles(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_nested.tf",
	)
}

func ConfigCDNAutoWithLoggingCloudfilesPlacementNone(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_nested_placement_none.tf",
	)
}

func ConfigCDNAutoWithLoggingCloudfilesUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_nested_updated.tf",
	)
}

func ConfigCDNAutoWithMultipleLoggingCloudfiles(serviceName, domainName, loggerName1, loggerName2 string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":              serviceName,
			"DOMAIN_NAME":               domainName,
			"LOGGING_CLOUDFILES_NAME_1": loggerName1,
			"LOGGING_CLOUDFILES_NAME_2": loggerName2,
		},
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_cloudfiles_nested_multi.tf",
	)
}

func ConfigCDNAutoWithBackendAndLoggingCloudfiles(serviceName, domainName, backendName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
...
func ConfigComputeAutoWithLoggingCloudfiles(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
...
// response_condition entirely, so this is expected to fail Terraform's own
// schema validation ("Unsupported argument") rather than reach the Fastly API.
func ConfigComputeAutoWithLoggingCloudfilesFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":            serviceName,
...
func ConfigLoggingLogglyBasic(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
			...
			"DOMAIN_NAME":         domainName,
			"SERVICE_VERSION":     "1",
			"LOGGING_LOGGLY_NAME": loggerName,
		},
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_loggly_basic.tf",
	)
}

// ConfigLoggingLogglyEmptyFormat sets format = "" - see TestAccFastlyServiceLoggingLoggly_emptyFormat.
func ConfigLoggingLogglyEmptyFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_loggly_empty_format.tf",
	)
}

func ConfigLoggingLogglyUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_loggly_updated.tf",
	)
}

func ConfigLoggingLogglyAtVersion(serviceName, domainName, loggerName string, version int) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
func ConfigLoggingLogglyForImport(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
// ConfigLoggingLogglyComputeFormat returns a config attaching
// fastly_service_logging_loggly to an explicit Compute service with format
// set, a VCL-only attribute. The standalone resource's schema is shared by both
// service types, so this is expected to fail at apply time via
// ValidateNoVCLOnlyAttributesForCompute rather than at Terraform's own
// schema-validation stage.
func ConfigLoggingLogglyComputeFormat(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/logging_loggly_compute_format.tf",
	)
}

// ConfigLoggingLogglyCompute returns a config attaching
// fastly_service_logging_loggly to an explicit Compute service with no
// VCL-only attributes set. ClearVCLOnlyCreateFields strips format from the
// create request, so the endpoint ends up with whatever format the Fastly API
// defaults to - see TestAccFastlyServiceLoggingLoggly_formatDefault.
func ConfigLoggingLogglyCompute(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/logging_loggly_compute.tf",
	)
}

func ConfigCDNAutoWithLoggingLoggly(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_loggly_nested.tf",
	)
}

func ConfigCDNAutoWithLoggingLogglyPlacementNone(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_loggly_nested_placement_none.tf",
	)
}

func ConfigCDNAutoWithLoggingLogglyUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_loggly_nested_updated.tf",
	)
}

func ConfigCDNAutoWithMultipleLoggingLoggly(serviceName, domainName, loggerName1, loggerName2 string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":          serviceName,
			"DOMAIN_NAME":           domainName,
			"LOGGING_LOGGLY_NAME_1": loggerName1,
			"LOGGING_LOGGLY_NAME_2": loggerName2,
		},
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_loggly_nested_multi.tf",
	)
}

func ConfigCDNAutoWithBackendAndLoggingLoggly(serviceName, domainName, backendName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
func ConfigComputeAutoWithLoggingLoggly(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
// ConfigComputeAutoWithLoggingLogglyFormat returns a Compute auto service
// config whose nested logging_loggly block sets format, a VCL-only
// attribute. service_compute_auto's logging_loggly schema
// (ComputeNestedBlockSchema) omits format/format_version/placement/
// response_condition entirely, so this is expected to fail Terraform's own
// schema validation ("Unsupported argument") rather than reach the Fastly API.
func ConfigComputeAutoWithLoggingLogglyFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_loggly_nested_compute_format.tf",
		"internal/acceptance_tests/blocks/package.tf",
	)
}
...
func ConfigLoggingScalyrBasic(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
			...
			"DOMAIN_NAME":         domainName,
			"SERVICE_VERSION":     "1",
			"LOGGING_SCALYR_NAME": loggerName,
		},
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_basic.tf",
	)
}

// ConfigLoggingScalyrEmptyFormat sets format = "" - see TestAccFastlyServiceLoggingScalyr_emptyFormat.
func ConfigLoggingScalyrEmptyFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_empty_format.tf",
	)
}

func ConfigLoggingScalyrUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_updated.tf",
	)
}

func ConfigLoggingScalyrAtVersion(serviceName, domainName, loggerName string, version int) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
func ConfigLoggingScalyrForImport(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
// ConfigLoggingScalyrComputeFormat returns a config attaching
// fastly_service_logging_scalyr to an explicit Compute service with format
// set, a VCL-only attribute. The standalone resource's schema is shared by both
// service types, so this is expected to fail at apply time via
// ValidateNoVCLOnlyAttributesForCompute rather than at Terraform's own
// schema-validation stage.
func ConfigLoggingScalyrComputeFormat(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/logging_scalyr_compute_format.tf",
	)
}

// ConfigLoggingScalyrCompute returns a config attaching
// fastly_service_logging_scalyr to an explicit Compute service with no
// VCL-only attributes set. ClearVCLOnlyCreateFields strips format from the
// create request, so the endpoint ends up with whatever format the Fastly API
// defaults to - see TestAccFastlyServiceLoggingScalyr_formatDefault.
func ConfigLoggingScalyrCompute(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/logging_scalyr_compute.tf",
	)
}

func ConfigCDNAutoWithLoggingScalyr(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_nested.tf",
	)
}

func ConfigCDNAutoWithLoggingScalyrPlacementNone(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_nested_placement_none.tf",
	)
}

func ConfigCDNAutoWithLoggingScalyrUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_nested_updated.tf",
	)
}

func ConfigCDNAutoWithMultipleLoggingScalyr(serviceName, domainName, loggerName1, loggerName2 string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":          serviceName,
			"DOMAIN_NAME":           domainName,
			"LOGGING_SCALYR_NAME_1": loggerName1,
			"LOGGING_SCALYR_NAME_2": loggerName2,
		},
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_nested_multi.tf",
	)
}

func ConfigCDNAutoWithBackendAndLoggingScalyr(serviceName, domainName, backendName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
func ConfigComputeAutoWithLoggingScalyr(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
...
// ConfigComputeAutoWithLoggingScalyrFormat returns a Compute auto service
// config whose nested logging_scalyr block sets format, a VCL-only
// attribute. service_compute_auto's logging_scalyr schema
// (ComputeNestedBlockSchema) omits format/format_version/placement/
// response_condition entirely, so this is expected to fail Terraform's own
// schema validation ("Unsupported argument") rather than reach the Fastly API.
func ConfigComputeAutoWithLoggingScalyrFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":        serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_scalyr_nested_compute_format.tf",
		"internal/acceptance_tests/blocks/package.tf",
	)
}
...
func ConfigLoggingKafkaBasic(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":       serviceName,
			...
			"DOMAIN_NAME":        domainName,
			"SERVICE_VERSION":    "1",
			"LOGGING_KAFKA_NAME": loggerName,
		},
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_kafka_basic.tf",
	)
}

// ConfigLoggingKafkaEmptyFormat sets format = "" - see TestAccFastlyServiceLoggingKafka_emptyFormat.
func ConfigLoggingKafkaEmptyFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_kafka_empty_format.tf",
	)
}

func ConfigLoggingKafkaUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/service_cdn_domain.tf",
		"internal/acceptance_tests/blocks/logging_kafka_updated.tf",
	)
}

func ConfigLoggingKafkaAtVersion(serviceName, domainName, loggerName string, version int) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":       serviceName,
...
func ConfigLoggingKafkaForImport(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDN,
		map[string]string{
			"SERVICE_NAME":       serviceName,
...
// ConfigLoggingKafkaComputeFormat returns a config attaching
// fastly_service_logging_kafka to an explicit Compute service with format
// set, a VCL-only attribute. The standalone resource's schema is shared by both
// service types, so this is expected to fail at apply time via
// ValidateNoVCLOnlyAttributesForCompute rather than at Terraform's own
// schema-validation stage.
func ConfigLoggingKafkaComputeFormat(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/logging_kafka_compute_format.tf",
	)
}

// ConfigLoggingKafkaCompute returns a config attaching
// fastly_service_logging_kafka to an explicit Compute service with no
// VCL-only attributes set. ClearVCLOnlyCreateFields strips format from the
// create request, so the endpoint ends up with whatever format the Fastly API
// defaults to - see TestAccFastlyServiceLoggingKafka_formatDefault.
func ConfigLoggingKafkaCompute(serviceName, loggerName string) string {
	return BuildConfig(
		ServiceCompute,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/logging_kafka_compute.tf",
	)
}

func ConfigCDNAutoWithLoggingKafka(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_kafka_nested.tf",
	)
}

func ConfigCDNAutoWithLoggingKafkaPlacementNone(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_kafka_nested_placement_none.tf",
	)
}

func ConfigCDNAutoWithLoggingKafkaUpdated(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_kafka_nested_updated.tf",
	)
}

func ConfigCDNAutoWithMultipleLoggingKafka(serviceName, domainName, loggerName1, loggerName2 string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":         serviceName,
			"DOMAIN_NAME":          domainName,
			"LOGGING_KAFKA_NAME_1": loggerName1,
			"LOGGING_KAFKA_NAME_2": loggerName2,
		},
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_kafka_nested_multi.tf",
	)
}

func ConfigCDNAutoWithBackendAndLoggingKafka(serviceName, domainName, backendName, loggerName string) string {
	return BuildConfig(
		ServiceCDNAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
...
func ConfigComputeAutoWithLoggingKafka(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
...
// ConfigComputeAutoWithLoggingKafkaFormat returns a Compute auto service
// config whose nested logging_kafka block sets format, a VCL-only
// attribute. service_compute_auto's logging_kafka schema
// (ComputeNestedBlockSchema) omits format/format_version/placement/response_condition
// entirely, so this is expected to fail Terraform's own schema validation
// ("Unsupported argument") rather than reach the Fastly API.
func ConfigComputeAutoWithLoggingKafkaFormat(serviceName, domainName, loggerName string) string {
	return BuildConfig(
		ServiceComputeAuto,
		map[string]string{
			"SERVICE_NAME":       serviceName,
		...
		"internal/acceptance_tests/blocks/domain_single.tf",
		"internal/acceptance_tests/blocks/logging_kafka_nested_compute_format.tf",
		"internal/acceptance_tests/blocks/package.tf",
	)
}
