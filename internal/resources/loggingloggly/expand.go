...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateLogglyInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateLogglyInput {
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateLogglyInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateLogglyInput {
...
func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateLogglyInput {
	...
	// schema.go). UpdateLogglyInput.Placement is a *Nullable[string] specifically
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateLogglyInput {
...
// response_condition on a CreateLogglyInput. The standalone
// fastly_service_logging_loggly resource shares one schema across both service
...
func ClearVCLOnlyCreateFields(input *fastly.CreateLogglyInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateLogglyInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateLogglyInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
