...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateHoneycombInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateHoneycombInput {
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateHoneycombInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateHoneycombInput {
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateHoneycombInput {
	return buildCommonUpdateInput(serviceID, version, m.commonModel)
}

func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateHoneycombInput {
	...
	// schema.go). UpdateHoneycombInput.Placement is a *Nullable[string]
...
// response_condition on a CreateHoneycombInput. The standalone
// fastly_service_logging_honeycomb resource shares one schema across both
...
func ClearVCLOnlyCreateFields(input *fastly.CreateHoneycombInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateHoneycombInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateHoneycombInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
