...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreatePapertrailInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreatePapertrailInput {
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreatePapertrailInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdatePapertrailInput {
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdatePapertrailInput {
	return buildCommonUpdateInput(serviceID, version, m.commonModel)
}

func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdatePapertrailInput {
	...
	// schema.go). UpdatePapertrailInput.Placement is a *Nullable[string]
...
// response_condition on a CreatePapertrailInput. The standalone
// fastly_service_logging_papertrail resource shares one schema across both
...
func ClearVCLOnlyCreateFields(input *fastly.CreatePapertrailInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdatePapertrailInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdatePapertrailInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
