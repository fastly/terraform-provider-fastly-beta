...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateGrafanaCloudLogsInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateGrafanaCloudLogsInput {
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateGrafanaCloudLogsInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateGrafanaCloudLogsInput {
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateGrafanaCloudLogsInput {
	return buildCommonUpdateInput(serviceID, version, m.commonModel)
}

func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateGrafanaCloudLogsInput {
	...
	// schema.go). UpdateGrafanaCloudLogsInput.Placement is a *Nullable[string]
...
// response_condition on a CreateGrafanaCloudLogsInput. The standalone
// fastly_service_logging_grafanacloudlogs resource shares one schema across
// both service types, so this is called instead of BuildComputeCreateInput
// to strip the VCL-only fields once the service is confirmed to be Compute.
func ClearVCLOnlyCreateFields(input *fastly.CreateGrafanaCloudLogsInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateGrafanaCloudLogsInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateGrafanaCloudLogsInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
