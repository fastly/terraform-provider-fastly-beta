...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateFTPInput {
	input := &fastly.CreateFTPInput{
		ServiceID:      serviceID,
		ServiceVersion: version,
		Name:           new(service.StringValue(m.Name)),
		Address:        new(service.StringValue(m.Address)),
		Username:       new(service.StringValue(m.User())),
		Password:       new(service.StringValue(m.Password())),
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateFTPInput {
...
// response_condition on a CreateFTPInput. The standalone
// fastly_service_logging_ftp resource shares one schema across both service
...
func ClearVCLOnlyCreateFields(input *fastly.CreateFTPInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateFTPInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateFTPInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateFTPInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateFTPInput {
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateFTPInput {
	return buildCommonUpdateInput(serviceID, version, m.commonModel)
}

func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateFTPInput {
	...
	// schema.go). UpdateFTPInput.Placement is a *Nullable[string] specifically
