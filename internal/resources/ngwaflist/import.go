...
// ImportState populates workspace_id and id from a "workspace_id/list_id"
// import identifier.
func ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	if len(parts) != 2 || parts[0] == "" || parts[1] == "" {
		resp.Diagnostics.AddError(
			...
			fmt.Sprintf("Expected import identifier of the form \"workspace_id/list_id\", got: %q", req.ID),
		)
		return
	}
