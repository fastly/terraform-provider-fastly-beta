...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateLogshuttleInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateLogshuttleInput {
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateLogshuttleInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateLogshuttleInput {
...
func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateLogshuttleInput {
	...
	// schema.go). UpdateLogshuttleInput.Placement is a *Nullable[string]
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateLogshuttleInput {
...
// response_condition on a CreateLogshuttleInput. The standalone
// fastly_service_logging_logshuttle resource shares one schema across both
...
func ClearVCLOnlyCreateFields(input *fastly.CreateLogshuttleInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateLogshuttleInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateLogshuttleInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
