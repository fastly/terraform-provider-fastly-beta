...
func buildCommonCreateInput(serviceID string, version int, m commonModel) *fastly.CreateOpenstackInput {
...
func BuildCreateInput(serviceID string, version int, m NestedModel) *fastly.CreateOpenstackInput {
...
// response_condition on a CreateOpenstackInput. The standalone
// fastly_service_logging_openstack resource shares one schema across both
...
func ClearVCLOnlyCreateFields(input *fastly.CreateOpenstackInput) {
	input.Format = nil
...
// ClearVCLOnlyUpdateFields is ClearVCLOnlyCreateFields for UpdateOpenstackInput.
func ClearVCLOnlyUpdateFields(input *fastly.UpdateOpenstackInput) {
	input.Format = nil
	input.FormatVersion = nil
	input.Placement = nil
	input.ResponseCondition = nil
...
func BuildComputeCreateInput(serviceID string, version int, m ComputeNestedModel) *fastly.CreateOpenstackInput {
...
// service-type-specific fields on top of this.
func buildCommonUpdateInput(serviceID string, version int, m commonModel) *fastly.UpdateOpenstackInput {
...
// sets format, format_version, placement, or response_condition, since those
// only affect generated VCL and Compute services don't have any.
func BuildComputeUpdateInput(serviceID string, version int, m ComputeNestedModel) *fastly.UpdateOpenstackInput {
	return buildCommonUpdateInput(serviceID, version, m.commonModel)
}

func BuildUpdateInput(serviceID string, version int, m NestedModel) *fastly.UpdateOpenstackInput {
	...
	// schema.go). UpdateOpenstackInput.Placement is a *Nullable[string]
