...
func (d *DataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ngwaf_workspace_templated_signal_rules"
}

func (d *DataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Use this data source to retrieve a list of Fastly Next-Gen WAF templated signal rules scoped to a single workspace.",
		Attributes: map[string]schema.Attribute{
			...
			"rules": schema.ListNestedAttribute{
				Computed:    true,
				Description: "The list of templated signal rules.",
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"signal": schema.StringAttribute{
							Computed:    true,
							Description: "Name of the templated signal the rule adds.",
						},
...
func (d *DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	tflog.Debug(ctx, "Reading Fastly NGWAF workspace templated signal rules", map[string]any{"workspace_id": workspaceID})

	remoteState, err := rules.List(ctx, d.client, &rules.ListInput{
		Limit: new(listLimit),
		Types: new(ngwafworkspacetemplatedsignalrule.RuleType),
		Scope: &scope.Scope{
	...
	if err != nil {
		resp.Diagnostics.AddError("Error listing NGWAF workspace templated signal rules", err.Error())
		return
	}
