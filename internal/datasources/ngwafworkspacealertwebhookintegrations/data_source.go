package ngwafworkspacealertwebhookintegrations
...
func NewDataSource() datasource.DataSource {
	return ngwafalertintegrations.NewWorkspaceDataSource(ngwafworkspacealertwebhookintegration.DefinitionForDataSource())
}
