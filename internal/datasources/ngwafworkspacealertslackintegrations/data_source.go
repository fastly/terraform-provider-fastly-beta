package ngwafworkspacealertslackintegrations
...
func NewDataSource() datasource.DataSource {
	return ngwafalertintegrations.NewWorkspaceDataSource(ngwafworkspacealertslackintegration.DefinitionForDataSource())
}
