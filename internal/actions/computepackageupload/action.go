...
func (a *Action) Invoke(ctx context.Context, req action.InvokeRequest, resp *action.InvokeResponse) {
	...
	if err := validation.EnsureServiceTypeSupported(ctx, a.providerData.TypeChecker, serviceID, "fastly_service_compute_package_upload", service.TypeCompute); err != nil {
