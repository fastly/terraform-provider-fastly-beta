...
- feat(service_authorization): add `fastly_service_authorization` resource for granting user permissions on a service ([#94](https://github.com/fastly/terraform-provider-fastly-beta/pull/94))
