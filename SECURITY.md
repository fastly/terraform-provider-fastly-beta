...
The fastly/terraform-provider-fastly-beta project team welcomes
security reports and is committed to providing prompt attention to
security issues. Security issues should be reported privately via
[Fastly’s security issue reporting
...
disclosure process. The fastly/terraform-provider-fastly-beta team
announces security issues in release notes as well as Github Security
Advisories on a best-effort basis.
