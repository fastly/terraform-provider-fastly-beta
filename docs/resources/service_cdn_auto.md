...
- `domain` (Block List) Domains attached to this service. Configures [classic domains](https://www.fastly.com/documentation/guides/getting-started/domains/about-domains/#working-with-classic-domains), available only on accounts created before September 16, 2025; the versionless [`fastly_domain`](domain.md) resource may be used instead. (see [below for nested schema](#nestedblock--domain))
...
- `authentication` (Attributes) Authentication credentials for your Rackspace Cloud Files account. (see [below for nested schema](#nestedatt--logging_cloudfiles--authentication))
...
<a id="nestedatt--logging_cloudfiles--authentication"></a>
### Nested Schema for `logging_cloudfiles.authentication`
...
- `authentication` (Attributes) Authentication credentials for your DigitalOcean Spaces account. (see [below for nested schema](#nestedatt--logging_digitalocean--authentication))
...
<a id="nestedatt--logging_digitalocean--authentication"></a>
### Nested Schema for `logging_digitalocean.authentication`
