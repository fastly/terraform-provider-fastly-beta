...
validation, and activation, use the nested `custom_vcl` block on
...
```shell
terraform import fastly_service_custom_vcl.main SERVICE_ID/VERSION/VCL_NAME
```

Example:

```shell
terraform import fastly_service_custom_vcl.main SU1Z0isxPaozGVKXdv0eY/3/main
```
