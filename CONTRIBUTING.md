...
[issue](https://github.com/fastly/terraform-provider-fastly-beta/issues/new)
...
```bash
$ git remote add upstream git@github.com:fastly/terraform-provider-fastly-beta.git
```
